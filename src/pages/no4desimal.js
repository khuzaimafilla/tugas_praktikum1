...
export default class No4desimal extends React.Component {
    constructor() {
        super()
        this.state = ({
            desimal: "",
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <button type="submit" className="w-100 btn btn-dark mt-4 mb-3 text-light">Konversi</button>
                        </form>
                    </div>
                    <div className="card-footer">
                        <h2 className="text-center mb-3">Hasil</h2>
                        <button className="w-100 alert alert-dark" name="result">{this.state.hasil}</button>
                    </div>
                </div>
            </div>
        )
